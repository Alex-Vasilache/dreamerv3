...
# `_shift_up`, `_shift_down` and `smooth_skill_event` are part of the
# neighbour-smoothed manager credit on the SOM-VAE branch and do not exist on
# main, so their tests live only there.
