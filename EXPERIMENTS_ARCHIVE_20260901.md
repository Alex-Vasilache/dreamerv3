# Experiment log archive — through 2026-09-01

Verbatim snapshot of `EXPERIMENTS.md` as it stood on 2026-09-01, before the
log was reset to a slim live board. Covers the e5xx–e7xx batches: the
manager-head variants, the SOM/LiP goal autoencoder, count-novelty and UCB
exploration, the JAX-vs-TF-Director audit, and the e718–e721 `director_stable`
null. Nothing here was edited; later archives do not supersede it.
