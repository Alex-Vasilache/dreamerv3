...
| e587–e591 | 4697638–42 | all 5 benchmarks / BIG | SOM-line+LiP + **Poisson manager** | 0 | 4M | *launched 2026-08-20* | one seed per task. Differs from e534–e573 by the **manager head alone**, so it is the direct comparison those runs support. |
